...
import com.arash.altafi.sensor.manageSetting.ManageSettingActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        btn_manage_setting.setOnClickListener {
            startActivity(Intent(this, ManageSettingActivity::class.java))
        }
    }
